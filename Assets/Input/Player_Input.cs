...
public partial class @Player_Input : IInputActionCollection2, IDisposable
{
    ...
    public struct Player_MovementActions
    {
        ...
        public Player_MovementActions(@Player_Input wrapper) { m_Wrapper = wrapper; }
        ...
        public void SetCallbacks(IPlayer_MovementActions instance)
        {
            if (m_Wrapper.m_Player_MovementActionsCallbackInterface != null)
            {
                ...
                @Crouch.started -= m_Wrapper.m_Player_MovementActionsCallbackInterface.OnCrouch;
                @Crouch.performed -= m_Wrapper.m_Player_MovementActionsCallbackInterface.OnCrouch;
                @Crouch.canceled -= m_Wrapper.m_Player_MovementActionsCallbackInterface.OnCrouch;
                @Sprint.started -= m_Wrapper.m_Player_MovementActionsCallbackInterface.OnSprint;
                @Sprint.performed -= m_Wrapper.m_Player_MovementActionsCallbackInterface.OnSprint;
                @Sprint.canceled -= m_Wrapper.m_Player_MovementActionsCallbackInterface.OnSprint;
            }
