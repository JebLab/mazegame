...
namespace Q3Movement
{
  ...
  public class Q3PlayerMotor : MonoBehaviour
  {
    ...
    public void ProcessMove(Vector2 m_Input)
    {
      m_MoveInput = new Vector3(m_Input.x, 0, m_Input.y);
    ...
    public void Jump()
    {
      if (m_Character.isGrounded == true && m_JumpQueued)
      {
        m_PlayerVelocity.y = m_JumpForce;
        m_JumpQueued = false;
      }
      if (m_Character.isGrounded == false && !m_JumpQueued)
      {
        m_JumpQueued = true;
      }
    }
