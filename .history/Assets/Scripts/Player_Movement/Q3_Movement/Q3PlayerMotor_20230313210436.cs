...
namespace Q3Movement
{
  ...
  public class Q3PlayerMotor : MonoBehaviour
  {
    ...
    [SerializeField] private Q3PlayerLook m_MouseLook = new Q3PlayerLook();
    ...
    // Used to reactivate sprinting  after jumping or falling
    private bool m_SprintQueued = false;
    ...
    void Start()
    {
      ...
      Q3PlayerLook.Init(m_Tran, m_CamTran);
    }
    ...
    private void Update()
    {
      var p_Input = g_Movement.Move.ReadValue<Vector2>();
      ...
      Q3PlayerLook.LookRotation(m_Tran, m_CamTran);
    ...
    public void ProcessMove(Vector2 p_Input)
    {
    ...
    // After jumping resume sprinting
    // private void QueueSprint()
    // {
    //   if (m_AutoSprint)
    //   {
    //     m_SprintQueued = Input.GetButton("Sprint");
    //   }
    ...
    private void GroundMove()
    {
      ...
      if (m_SprintQueued)
      {
        wishspeed *= m_GroundSettings.MaxSpeed * 2;
      }
    }
