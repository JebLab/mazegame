...
namespace Q3Movement
{
  ...
  public class Q3PlayerLook
  {
    ...
    private NewPlayerInput c_Movement;
    private NewPlayerInput.PlayerActions cam_Movement;
    ...
    {
      float yRot = Input.GetAxis() * m_XSensitivity;
      float xRot = Input.GetAxis("Look") * m_YSensitivity;
